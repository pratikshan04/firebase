! function() {
 ...
 s("1", tinymce.PluginManager), s("6", tinymce.util.Delay), s("e", tinymce.util.Tools), s("9", tinymce.html.SaxParser), s("a", tinymce.html.Schema), s("b", tinymce.dom.DOMUtils.DOM), a("h", [], function() {
  ...
  var e = function(e, t) {
   ...
   n = function(t, n, r) {
    var i = t.state.get("oldVal"),
     o = n.state.get("oldVal"),
     a = t.value(),
     s = n.value();
  ...
  var l = a.ie && a.ie <= 8 ? "onChange" : "onInput",
   c = function(e) {
    return function(t) {
   ...
   f = function(e, n) {
    return function(r) {
     var i = r.html,
      a = e.find("#embed")[0],
      l = o.extend(t.htmlToData(n.settings.media_scripts, i), {
       source1: r.url
      });
  ...
  return {
   createPreviewIframeNode: o,
   createPlaceholderNode: i,
   placeHolderConverter: l
  }
