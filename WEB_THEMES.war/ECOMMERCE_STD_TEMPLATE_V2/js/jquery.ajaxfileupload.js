...
(function($) {
    $.fn.ajaxfileupload = function(options) {
        var settings = {
          ...
          valid_extensions : ['gif','png','jpg','jpeg','txt','docx', 'doc','pdf','mkv'],
          submit_button : null
        };
        ...
        return this.each(function() {
          ...
          */
          var handleResponse = function(loadedFrame, element) {
        	  var customResponse = loadedFrame.contentWindow.document.body.innerHTML;
        	  //customResponse = $(customResponse).text();
            ...
            settings.onComplete.apply(element, [{status: true, message: customResponse.trim()} , settings.params]);
          };
